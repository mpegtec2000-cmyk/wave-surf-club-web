    ...
    <div className="agenda-master">
      ...
      <main className="booking-main">
        <div className="hero-bg">
          <Image src="/PORTADA.jpg" alt="Background" fill priority style={{ objectFit: 'cover' }} />
      ...
      <style jsx>{`
        .agenda-master { min-height: 100vh; background: #0b1120; color: #fff; padding-top: 95px; font-family: sans-serif; }
        ...
        .btn-primary, .btn-primary-blue { width: 100%; height: 60px; background: #38bdf8; color: #000; border: none; border-radius: 16px; font-weight: 900; cursor: pointer; margin-top: 10px; display: flex; align-items: center; justify-content: center; gap: 8px; }
        ...
        .btn-ghost { width: 100%; padding: 15px; background: none; border: none; color: #64748b; font-weight: 700; cursor: pointer; text-align: center; display: block; text-decoration: none; }
        .alumnos-grid { display: flex; gap: 10px; margin-bottom: 30px; }
        .al-pill { flex: 1; height: 50px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; color: #fff; display: flex; align-items: center; justify-content: center; cursor: pointer; font-weight: 800; }
        .al-pill.active { background: #38bdf8; color: #000; }
        .summary-box { background: rgba(255,255,255,0.03); border-radius: 20px; padding: 30px; margin-bottom: 25px; border: 1px solid rgba(255,255,255,0.05); }
        .summary-row { display: flex; justify-content: space-between; margin-bottom: 20px; align-items: center; }
        .total-row { display: flex; justify-content: space-between; font-size: 24px; font-weight: 900; color: #fff; }
        .info-alert { display: flex; gap: 10px; color: #94a3b8; font-size: 13px; margin-bottom: 30px; align-items: center; }
        ...
        .mini-card { background: rgba(0,0,0,0.3); border-radius: 16px; padding: 20px; margin-top: 30px; text-align: left; }
        .mini-card .row { display: flex; justify-content: space-between; margin-bottom: 8px; font-size: 13px; }
        .celeste { color: #38bdf8; }
        .anim-fade { animation: fadeIn 0.4s ease-out; }
        @keyframes fadeIn { from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); } }
        @media (max-width: 968px) { .booking-card { grid-template-columns: 1fr; } .agenda-master { padding-top: 70px; } }
      `}</style>
    </div>
  );
}

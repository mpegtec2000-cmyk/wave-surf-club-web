export const RIDERS_DATA = {
  ...
  'angelo-avello': {
    ...
    role: 'RIDER',
    cover: 'https://images.unsplash.com/photo-1520156584202-0e94b9f01391?auto=format&fit=crop&w=1200&q=80',
    bio: '<p>Angelo Avello se une al equipo para demostrar que the surf es más que un deporte, es una forma de vida. Su estilo fluido y compromiso con la excelencia lo posicionan como un talento a seguir.</p>',
    stats: { board: 'Wave Tech 6\'2"', stance: 'Regular', local: 'Concón' },
    gallery: ['https://images.unsplash.com/photo-1520156584202-0e94b9f01391?auto=format&fit=crop&w=1200&q=80']
  },
  'cristobal-lazcano': {
  ...
  'morrison-tapia': {
    ...
    cover: '/riders/Morrison-Tapia/perfil.png',
    bio: `
    ...
    gallery: [
      '/riders/Morrison-Tapia/1.PNG',
      '/riders/Morrison-Tapia/2.PNG',
      '/riders/Morrison-Tapia/3.PNG',
      '/riders/Morrison-Tapia/4.PNG',
      '/riders/Morrison-Tapia/Captura.PNG',
      '/riders/Morrison-Tapia/perfil.png'
    ],
